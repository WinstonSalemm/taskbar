                  ...
                  <tr className="excel-row">
                    ...
                    <td className="excel-value">
                      <div className="file-upload-cell">
                        ...
                        {screenshotMode && (
                          <span className="screenshot-hint">Ctrl+V для вставки</span>
                        )}
                      </div>
                    </td>
                  </tr>
                ...
                <>
                  ...
                  <tr className="excel-row">
                    ...
                    <td className="excel-value">
                      <input
                        ...
                        onChange={e => setInvoiceData({...invoiceData, inn: e.target.value.replace(/\D/g, '')})}
                        className="excel-input"
                  ...
                  <tr className="excel-row excel-total">
                    ...
                    <td className="excel-value">
                      <input
                        type="text"
                        value={invoiceData.price && invoiceData.quantity 
                  ...
                  <tr className="excel-row">
                    ...
                    <td className="excel-value">
                      <textarea
                        ...
                        onChange={e => setOtherData({...otherData, essence: e.target.value})}
                        className="excel-textarea"
                        rows={2}
                  ...
                  <tr className="excel-row">
                    ...
                    <td className="excel-value">
                      <textarea
                        ...
                        onChange={e => setOtherData({...otherData, aspects: e.target.value})}
                        className="excel-textarea"
                        rows={2}
                ...
                <td className="excel-value">
                  ...
                  {screenshotMode && (
                    <div className="screenshot-hint-block">
                      💡 Нажмите <strong>Ctrl+V</strong> для вставки скриншота из буфера
                    </div>
                  )}
